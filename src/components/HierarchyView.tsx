...
function OutcomeCard({
  ...
  return (
    <div
      id={outcome.id}
      className={`bg-sky-50/50 dark:bg-sky-950/20 rounded-lg border border-sky-200 dark:border-sky-800/40 border-l-[3px] ${borderColor} shadow-sm overflow-hidden`}
    >
      {/* Outcome header */}
      <div
        onClick={onOutcomeClick}
        className="px-4 py-3 cursor-pointer hover:bg-sky-100/50 dark:hover:bg-sky-950/40 transition-colors"
      >
