  ...
  return (
    <div className="flex flex-col items-center justify-center min-h-screen px-6 py-12 gap-12">
      ...
      <div className="flex flex-col items-center text-center">
        ...
        <Link
          href="/board"
          className="mt-3 inline-flex items-center justify-center border-2 border-indigo-300 dark:border-indigo-600 text-indigo-600 dark:text-indigo-400 hover:bg-indigo-50 dark:hover:bg-indigo-950/30 font-semibold rounded-xl px-8 py-2.5 text-sm transition-colors"
        >
          Try the demo
        </Link>
      </div>
